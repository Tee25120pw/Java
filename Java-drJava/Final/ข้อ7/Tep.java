...
public class Tep{
  public static void main(String args[]) {
    JPanel x = new JPanel(); //panel หลัก
    JPanel x3 = new JPanel(); //panel ปุ่มหมายเลข
    JPanel p3 = new JPanel(); //panel ปุ่มหมายเลข
    JPanel p6 = new JPanel(); //panel ส่วนปุ่มทั้งหมด
    x.setLayout(new BorderLayout()); //จัดตำแหน่ง
    ...
    p6.setLayout(new GridLayout(2,2,5,0)); //แบ่ง p6 เป็น grid layout ขนาด 1*1
