...
/*
public class mid1 {     //ข้อ Square น่าจะเป็นของข้อ 4
  private double width;
  private double height;
  public Square() {
    this.width = width;
