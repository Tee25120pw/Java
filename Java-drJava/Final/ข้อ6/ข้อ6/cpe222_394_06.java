...
public class cpe222_394_06{
  public static void main(String args[]){
    ...
    JButton jbt5 = new JButton("4");
    JButton jbt6 = new JButton("5");
    JButton jbt7 = new JButton("6");
    JButton jbt8 = new JButton("-");
    JButton jbt9 = new JButton("7");
    JButton jbt10 = new JButton("8");
    JButton jbt11 = new JButton("9");
...
usertxt = new JTextField(14);
pwtxt = new JPasswordField(14);
